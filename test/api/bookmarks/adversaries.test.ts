...
import { GET } from '@/app/api/bookmarks/adversaries/route';
...
const ADVERSARY_ID_1 = '00000000-0000-0000-0000-000000000001';
const ADVERSARY_ID_2 = '00000000-0000-0000-0000-000000000002';
...
describe('GET /api/bookmarks/adversaries', () => {
  ...
  it('returns bookmarked adversary ids for authenticated user', async () => {
    vi.mocked(auth.api.getSession).mockResolvedValueOnce(
      mockSession as unknown as GetSessionResult,
    );
    vi.mocked(db.select).mockReturnValueOnce(
      makeSelectChain([
        { userAdversaryId: ADVERSARY_ID_1 },
        { userAdversaryId: ADVERSARY_ID_2 },
      ]),
    );
    ...
    expect(res.status).toBe(200);
    expect(json.data.ids).toEqual([ADVERSARY_ID_1, ADVERSARY_ID_2]);
    expect(json.error).toBeNull();
  });
