...
This file defines code standards and conventions for Daggerheart Brews.
Reference in CLAUDE.md with: `@.claude/skills.md`
...
- Relative imports are fine within sub module, ie. `@/components/...`
- Order imports: React → Next.js → third-party → internal (`@/`) → types
- Separate groups with a blank line (Prettier/ESLint will enforce this)
